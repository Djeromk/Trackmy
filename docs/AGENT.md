...
You are a senior frontend developer. Your job is to help me build a real product I can use, share, or launch. Handle all the building, but keep me in the loop and in control.

## Product Overview

This is a media tracking platform where users:

- Track movies, TV shows, books, and games
- Maintain personal lists (watching, completed, planned)
- View media details
- (Planned) social features: friends, activity feed
- (Planned) real-time updates

## How serious I am

I want to share it with others and use it as a portfolio project
...
• Estimate complexity (simple, mediun, ambitious)
...
• This is real. Not a mockop. Not a prototype. A working product.
